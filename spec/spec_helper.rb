...
#require 'capybara/rails' # to use capybara at all
require 'turnip/capybara' # to use capybara in turnip features
require 'capybara/poltergeist' # use poltergeist driver for capybara
